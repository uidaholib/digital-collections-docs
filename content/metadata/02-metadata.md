...
- Free text field to describe how the item was transcribed. This field is intended to help future users understand how the transcript was created/generated and provide transparency.
- Please include original creators, services or AI models, and reviewers or editors. Provide detail that will help future review of the transcripts.
- Include a year if other than when the collection was created, or if it was transcribed in different batches.
- Example value: `Otter AI, reviewed by Klytie 2023`, `Adobe Premiere Pro, 2024`

### cataloger

- Free text field to describe how the metadata record was created. This field is intended to help future users understand how the metadata was created/generated and provide transparency.
- Please include original creators, services or AI models, and reviewers or editors. Provide detail that will help future metadata work understand the origins and issues that may exisit. For example, if the records were adapted from an existing finding aid, harvested from a website, or generated by AI.
- Include a year if other than when the collection was created, or if items were described in different batches.
- Example value: `CDIL students, 2017`, `SBW Project, 2013`, `Harvested from Wilderness Voices website, 2013`
