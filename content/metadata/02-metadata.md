...
- This is the formula to populate the archival date field in Google Sheets using the previous "date" field in the format YYYY-MM-DD. The cell value refers to the cell containing the date. For example: `A2`
